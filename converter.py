...
class MediaConverter:
    ...
    def preview_file_info(self, filepath: str) -> Dict:
        ...
        duration_sec = float(info.get('duration', info.get('format.duration', 0)))
        size_bytes = int(info.get('size', info.get('format.size', 0)))
        bitrate = int(info.get('bit_rate', info.get('format.bit_rate', 0)))
